...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [_sliderBtn setImage:[UIImage imageNamed:@"lines_play"] forState:UIControlStateNormal];
        ...
        [_sliderBtn addTarget:self action:@selector(end2SliderScrubbing) forControlEvents:UIControlEventTouchUpInside];
