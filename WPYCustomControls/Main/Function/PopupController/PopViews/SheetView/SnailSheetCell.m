...
- (void)setLayout:(SnailSheetViewLayout *)layout appearance:(SnailSheetViewAppearance *)appearance model:(SnailSheetItemModel *)model {
    ...
    [_imageView setBackgroundImage:[self imageWithColor:appearance.imageViewBackgroundColor] forState:UIControlStateNormal];
    [_imageView setBackgroundImage:[self imageWithColor:appearance.imageViewHighlightedColor] forState:UIControlStateHighlighted];
    ...
    // layout
    _imageView.frame = CGRectMake(_imageView.frame.origin.x, _imageView.frame.origin.x, layout.imageViewWidth, layout.imageViewWidth);
    
    _imageView.center = CGPointMake(layout.itemSize.width / 2, _imageView.center.y);
    ...
    if (_textLabel.text.length > 0) {
        ...
        _textLabel.frame = CGRectMake(0, CGRectGetMaxY(_imageView.frame) + layout.subSpacing, layout.itemSize.width, size.height);
        _textLabel.center =CGPointMake(layout.itemSize.width / 2, _textLabel.center.y) ;
